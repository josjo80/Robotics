...
def perception_step(Rover):
    ...
    scale = 10
    navigable_x_world, navigable_y_world = pix_to_world(x_pixel_nav, y_pixel_nav, Rover.pos[0], 
                                                        Rover.pos[1], Rover.yaw, world_size, scale)
    obstacle_x_world, obstacle_y_world = pix_to_world(x_pixel_obs, y_pixel_obs, Rover.pos[0], 
                                                      Rover.pos[1], Rover.yaw, world_size, scale)
    ...
    dists, angles = to_polar_coords(x_pixel_nav, y_pixel_nav)
